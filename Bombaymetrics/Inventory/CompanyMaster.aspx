<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CompanyMaster.aspx.cs" Inherits="Bombaymetrics.Inventory.CompanyMaster" %>
    ...
    <div class="container">
        <div class="row justify-content-center mt-5  pt-5 pb-5">
            <div class="col-md-8 pb-5" style="border: solid #F8F8F8; box-shadow: 0px 5px 5px #aaaaaa;">
                <h5 style="text-align: center; background-color: #304480; color: white; padding: 0.6em" runat="server" id="header">ADD COMPANY DETAILS</h5>
                <div class="row pt-2">
                    ...
                    <div class="col-md-6 p-2">
                        <div class="form-group" style="">
                            <label class="control-label visible-ie8 visible-ie9">Enter GSTIN</label>
                            <asp:TextBox ID="txtGSTIN" class="form-control form-control-solid placeholder-no-fix" BorderColor="Orange" BorderStyle="Solid" placeholder="GSTIN" runat="server"></asp:TextBox>
                            <span class="help-block">
                                <asp:RequiredFieldValidator ID="requiredfieldvalidator7" runat="server" ControlToValidate="txtGSTIN"
                                    SetFocusOnError="true" ErrorMessage="Please enter GSTIN" ForeColor="red">
                                </asp:RequiredFieldValidator>
                            </span>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 p-2 ">
                        <div class="form-group" style="">
                            ...
                            <asp:TextBox ID="txtAddress" TextMode="Multiline" class="form-control form-control-solid placeholder-no-fix" BorderColor="Orange" BorderStyle="Solid" placeholder="Supplier Address" runat="server"></asp:TextBox>
                            <span class="help-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 p-2">
                     ...
                     <div class="col-md-6 p-2">
                        <div class="form-group" style="">
                             <label class="control-label visible-ie8 visible-ie9">Enter CIN</label>
                            <asp:TextBox ID="txtCIN" class="form-control form-control-solid placeholder-no-fix" BorderColor="Orange" BorderStyle="Solid" placeholder="CIN" runat="server"></asp:TextBox>
                            <span class="help-block">
                                <asp:RequiredFieldValidator ID="requiredfieldvalidator6" runat="server" ControlToValidate="txtCIN"
                                    SetFocusOnError="true" ErrorMessage="Please enter CIN" ForeColor="red"></asp:RequiredFieldValidator>
                            </span>
                        </div>
                    </div>
                </div>
